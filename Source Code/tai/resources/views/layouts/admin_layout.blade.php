...
<head>
    ...
    <meta name="keywords" content="TAI | ADMIN DASHBOARD" />
        ...
        <div class="mother-grid-inner">
            ...
            <div class="header-main">
                <div class="header-left">
                    <div class="logo-name">
                        <a href="{{url('/')}}"> <h2 style="color: #7fb82d;">TAI</h2>
                        </a>
                    </div>
                </div>
                            ...
                            <li class="dropdown profile_details_drop">
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                                    <div class="profile_img">
                                        @php $image = Auth::guard("admin")->user()->admin_image; @endphp
                                        <span class="prfil-img"><img src={{asset("images/$image")}} alt="" width="40" style="border-radius:50%"> </span>
                                        <div class="user-name">
                                            <p style="color: #7fb82d;">{{Auth::guard("admin")->user()->admin_name}}</p>
    ...
    <div class="sidebar-menu">
        ...
        <div class="menu">
            <ul id="menu" >
                ...
                <li><a><i class="fa fa-file"></i><span>Manage articles</span><span class="fa fa-angle-right" style="float: right"></span></a>
                    <ul>
                ...
                <div class="{{(request()->getRequestUri() == '/admin/manageUser' || request()->getRequestUri() == '/admin/viewUser') ? 'active': ''}}">
                    <li><a href="{{url('admin/viewUser')}}" style="color:{{request()->getRequestUri() == '/admin/viewUser' ? '': 'white'}}"><i class="fa fa-users"></i><span>Users</span></a></li>
                </div>


       
                <div class="{{request()->getRequestUri() == '/admin/manageContact' ? 'active': ''}}">
                    <li><a href="{{url('admin/manageContact')}}"><i class="fa fa-question"></i><span>Contact us messages</span></a></li>
                </div>
