                ...
                <div class="centerProflile">
                    <form action="/profile/{{Auth::user()->user_id}}" class="form" method="post" enctype="multipart/form-data">
                        ...
                        <div class="formRow">
                            ...
                            <div class="input">
                                <input id="user_name" name="user_name" placeholder=" {{ Auth::user()->user_name }}" type="text" class=" @error('user_name') is-invalid @enderror" name="user_name" value="{{  Auth::user()->user_name }} " autocomplete="user_name" autofocus>
                                @error('user_name')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="formRow">
                            ...
                            <div class="input">
                                <input id="email" name="email" placeholder="{{ Auth::user()->email }}" type="email" class=" @error('email') is-invalid @enderror" name="email" value="{{  Auth::user()->email }} " autocomplete="email">
                                @error('email')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="input">
                            <input id="user_number" type="number" class=" @error('user_number') is-invalid @enderror" name="user_number" value="{{Auth::user()->user_number }}" required placeholder="Your Phone Number" autocomplete="user_number">  
                            @error('user_number')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="formRow">
                            ...
                            <div class="input">
                            <input id="user_age" type="number" placeholder="Age" class=" @error('user_age') is-invalid @enderror" name="user_age" value="{{Auth::user()->user_age }}" required autocomplete="user_age">
                            @error('user_age')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="formRow">
                            ...
                            <div class="input">
                            <input id="user_password" type="password" placeholder="Password" class=" @error('user_password') is-invalid @enderror" name="user_password" required autocomplete="new-user_password">
                            @error('user_password')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="center-Flex">
                            <button class="edit" style="background:#7fb82d; color:white; width: 20%" type="submit" >
                            {{__("Done")}}
                            </button>
